import styles from "./LinkedInTooltip.module.css";
    ...
    <div className={styles["tooltip-container"]}>
      <div className={styles.tooltip}>
        <div className={styles.profile}>
          ...
          <div className={styles.about}>482 Connections</div>
        </div>
      </div>
      <div className={styles.text}>
        <a
          className={styles.icon}
          href="https://www.linkedin.com/in/manish-kumar-dev/"
          target="_blank"
        >
          <div className={styles.layer}>
            ...
            <span className={styles["fab"]}>
              <svg viewBox="0 0 448 512" width={"24px"} height="1em">
